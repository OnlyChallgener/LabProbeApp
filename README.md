...
这是 v0.3.0 测试版。当前 APK 是 debug 包，适合自用测试。
...
## v0.3.0 修复
- Hub 请求使用 OkHttp 自定义 DNS，默认 223.5.5.5，优先 AAAA，避免系统 DNS 返回 127.0.0.1。
- 工具页增加功能导航与说明。
- SSH 改用 mwiede JSch 并增强 ssh-rsa / 老 KEX 兼容。
- 首页继续以 NAS 出口地址为主，路由器 IPv6 暂不显示。
