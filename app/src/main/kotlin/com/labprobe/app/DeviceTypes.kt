...
val DEVICE_TYPE_RULES: List<DeviceTypeRule> = listOf(
    DeviceTypeRule(
        ...
        keywords = listOf("router", "openwrt", "istoreos", "mesh", "gateway", "ap", "路由", "网关", "无线AP", "be72", "rg-", "ew", "ax", "ac", "s8067"),
        brands = listOf("华为", "huawei", "中兴", "zte", "新华三", "h3c", "tp-link", "tplink", "普联", "腾达", "tenda", "d-link", "dlink", "友讯", "网件", "netgear", "华硕", "asus", "小米", "xiaomi", "红米", "redmi", "领势", "linksys", "360", "睿易", "reyee", "ruijie", "unifi", "ubnt", "ubiquiti", "极路由", "hiwifi")
    ),
    DeviceTypeRule("nas", "NAS", "nas", Color(0xFF0EA5E9), wolDefault = true, priority = 96,
        keywords = listOf("nas", "storage", "truenas", "unraid", "dh4300", "dh4300plus", "dx4600", "fs6706", "私有云", "网络存储"),
        brands = listOf("群晖", "synology", "威联通", "qnap", "极空间", "zspace", "绿联", "ugreen", "铁威马", "terramaster")),
    ...
    DeviceTypeRule("laptop", "笔记本电脑", "laptop", Color(0xFF3B82F6), wolDefault = false, priority = 85,
        keywords = listOf("laptop", "notebook", "macbook", "book", "笔记本", "matebook", "magicbook", "redmibook"),
    ...
    DeviceTypeRule("phone", "手机", "phone", Color(0xFF22C55E), priority = 86,
        keywords = listOf("iphone", "android", "phone", "mobile", "mate", "pura", "reno", "find", "iqoo", "vivo", "oppo", "realme", "oneplus", "galaxy", "pixel", "手机"),
        brands = listOf("apple", "huawei", "honor", "xiaomi", "redmi", "samsung", "oppo", "vivo", "iqoo", "realme", "oneplus")),
    ...
    DeviceTypeRule("watch", "手表", "watch", Color(0xFF8B5CF6), priority = 84,
        keywords = listOf("watch", "wear", "band", "手表", "手环")),

    DeviceTypeRule("tv", "电视/智慧屏", "tv", Color(0xFF7C3AED), priority = 78,
        keywords = listOf("tv", "television", "智慧屏", "电视", "盒子", "box", "mitv"), brands = listOf("海信", "hisense", "tcl", "创维", "skyworth", "小米", "xiaomi", "索尼", "sony", "华为", "huawei")),
    DeviceTypeRule("projector", "投影仪", "projector", Color(0xFF8B5CF6), priority = 78,
        keywords = listOf("projector", "projection", "投影", "投影仪"), brands = listOf("极米", "xgimi", "当贝", "dangbei", "坚果", "jmgo")),
    DeviceTypeRule("speaker", "智能音箱", "speaker", Color(0xFF14B8A6), priority = 78,
        keywords = listOf("speaker", "sound", "audio", "homepod", "小爱", "天猫精灵", "音箱", "音响", "xiaomi sound", "miaisoundbox"), brands = listOf("小爱", "天猫精灵", "华为", "索尼", "sony", "xiaomi", "mi")),
    DeviceTypeRule("camera", "摄像头", "camera", Color(0xFFEF4444), priority = 78,
        keywords = listOf("camera", "cam", "ipc", "nvr", "摄像", "摄像头", "ezviz"), brands = listOf("海康", "hikvision", "萤石", "ezviz", "小米", "360", "tp-link", "tplink")),
    ...
    DeviceTypeRule("aircon", "空调", "aircon", Color(0xFF06B6D4), priority = 72,
        keywords = listOf("aircon", "air conditioner", "ac", "空调"), brands = listOf("格力", "gree", "美的", "midea", "海尔", "haier", "华凌", "tcl")),
    DeviceTypeRule("fridge", "冰箱", "fridge", Color(0xFF0EA5E9), priority = 72,
        keywords = listOf("fridge", "refrigerator", "冰箱"), brands = listOf("海尔", "haier", "美的", "midea", "容声", "ronshen", "卡萨帝", "casarte", "西门子", "siemens")),
    DeviceTypeRule("fresh_air", "新风", "aircon", Color(0xFF06B6D4), priority = 70,
        keywords = listOf("fresh air", "新风"), brands = listOf("松下", "panasonic", "美的", "midea", "小米", "352")),
    DeviceTypeRule("washer", "洗衣/洗烘", "washer", Color(0xFF0EA5E9), priority = 72,
        keywords = listOf("washer", "washing", "dryer", "洗衣", "洗烘"), brands = listOf("海尔", "小天鹅", "美的", "西门子")),
    DeviceTypeRule("water_heater", "热水器", "heater", Color(0xFFF97316), priority = 76,
        keywords = listOf("water heater", "heater", "热水器", "热水"), brands = listOf("美的", "midea", "海尔", "haier", "林内", "rinnai", "万和", "vanward")),
    ...
    DeviceTypeRule("robot_vacuum", "扫地机器人", "cleaner", Color(0xFF10B981), priority = 74,
        keywords = listOf("vacuum", "robot", "sweeper", "扫地", "扫地机器人"), brands = listOf("科沃斯", "石头", "云鲸", "小米")),
    DeviceTypeRule("vacuum", "吸尘器", "cleaner", Color(0xFF10B981), priority = 66,
        keywords = listOf("vacuum", "吸尘器"), brands = listOf("戴森", "dyson", "追觅", "美的")),
    DeviceTypeRule("dryer", "电动晾衣架", "curtain", Color(0xFF22C55E), priority = 64,
        keywords = listOf("晾衣", "clothes dryer"), brands = listOf("好太太", "邦先生", "小米")),
    ...
    DeviceTypeRule("air_purifier", "空气净化器", "aircon", Color(0xFF06B6D4), priority = 70,
        keywords = listOf("air purifier", "净化器", "空气净化"), brands = listOf("小米", "352", "美的", "飞利浦", "philips")),
    ...
    DeviceTypeRule("printer", "打印机", "printer", Color(0xFFF59E0B), priority = 74,
...
fun deviceTypeById(id: String?): DeviceTypeRule = DEVICE_TYPE_RULES.firstOrNull { it.id.equals(id, ignoreCase = true) }
...
fun normalizeDeviceTypeToken(raw: String): String {
    ...
    return when {
        s.contains("nas") || s.contains("群晖") || s.contains("绿联") || s.contains("威联通") || s.contains("极空间") -> "nas"
        s.contains("台式") || s == "pc" || s.contains("主机") -> "desktop"
        s.contains("笔记") || s.contains("laptop") -> "laptop"
        s.contains("路由") || s.contains("ap") -> "router"
        s.contains("手机") -> "phone"
        s.contains("平板") -> "tablet"
        s.contains("音箱") || s.contains("音响") -> "speaker"
        s.contains("热水") -> "water_heater"
        s.contains("空调") -> "aircon"
        s.contains("电视") || s.contains("智慧屏") -> "tv"
        s.contains("灯") -> "light"
        s.contains("摄像") -> "camera"
        else -> ""
    }
}
