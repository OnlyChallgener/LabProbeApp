...
fun parseEvents(json: String): List<EventItem> {
    ...
    for (i in 0 until arr.length()) {
        ...
        out += EventItem(
            ...
            manufacture = formatManufacturer(field("manufacture").ifBlank { field("vendor") }.ifBlank { field("oui") }),
...
private fun parseDevice(o: JSONObject?): DeviceItem? {
    ...
    return DeviceItem(
        ...
        manufacture = formatManufacturer(f("manufacture").ifBlank { f("vendor") }.ifBlank { f("oui") }),
