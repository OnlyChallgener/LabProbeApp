...
if __name__ == "__main__":
    ...
    if not final_generated:
        ...
        # GitHub workflows run this script explicitly, and Gradle preBuild runs
        # it again. The final generated sources are already complete.
        print("Android source fixes already prepared")
